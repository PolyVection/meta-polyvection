...
IMAGE_INSTALL_append = " u-boot-fw-utils-pv alsa-utils usbutils i2c-tools wpa-supplicant iperf polyos-wifi shairport-sync bluez5 ntp polyos-updater fsl-alsa-plugins libxml2-dev sigma-loader alsa-asound"
